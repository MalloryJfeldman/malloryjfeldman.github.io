...
sidebar <- tags$div(
  ...
  tags$div(class="keyword-item", style="cursor:pointer; padding:4px 0; font-weight:600; color:black;", `data-keyword`="ALL", "Show All"),
  lapply(all_keywords, function(kw) tags$div(class="keyword-item", style="cursor:pointer; padding:2px 0; font-size:0.9rem; color:black;", `data-keyword`=kw, kw))
)
```
...
.pub-actions a{text-decoration:none;font-size:0.92rem;border-bottom:1px dotted #999;color:black;cursor:pointer;}
